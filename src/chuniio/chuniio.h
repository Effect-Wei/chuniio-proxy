...
#ifndef CHUNIIO_API
#if defined(CHUNIIO_EXPORTS)
#define CHUNIIO_API __declspec(dllexport)
#elif defined(CHUNIIO_IMPORTS)
...
CHUNIIO_API uint16_t chuni_io_get_api_version(void);
...
CHUNIIO_API HRESULT chuni_io_jvs_init(void);
...
CHUNIIO_API HRESULT chuni_io_slider_init(void);
...
CHUNIIO_API HRESULT chuni_io_led_init(void);
...
CHUNIIO_API void chuni_io_led_set_colors(uint8_t board, uint8_t *rgb);
